...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q5_Q0] = {
        .type_name                = "q5_q0",
        .blck_size                = QK5_Q0,
        .type_size                = sizeof(block_q5_q0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q5_q0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q5_q0_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q5_Q0:         wtype = GGML_TYPE_Q5_Q0; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q5_Q0:   result = quantize_q5_q0  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
