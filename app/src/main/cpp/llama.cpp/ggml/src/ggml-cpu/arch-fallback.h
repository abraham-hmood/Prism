...
#define ggml_vec_dot_q5_q0_q8_0_generic ggml_vec_dot_q5_q0_q8_0
...
// quants.c
// Arm hand-writes the rest of quants.c, which is why this branch aliases nothing else from it --
// but there is no Neon version of the quinary type, so on the one architecture Android actually
// ships on, the generic implementation has to be the public symbol or the link fails.
#define ggml_vec_dot_q5_q0_q8_0_generic ggml_vec_dot_q5_q0_q8_0
// repack.cpp
#define ggml_quantize_mat_q8_K_4x4_generic ggml_quantize_mat_q8_K_4x4
#define ggml_quantize_mat_q8_K_4x8_generic ggml_quantize_mat_q8_K_4x8
