...
package prism.desktop.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/prism.desktop.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/prism.desktop.generated.resources/" + path)
